...
# function to save data as a .pkl
...
# function to build a year-link dictionary
...
# function to add links to other tables to year_links_dict
...
# function to scrape the number of stages in a given year 
...
# function to add the number of stages to the year-links dictionary
...
# function to scrape data from the starters table for a given year
...
# function to scrape data from the stages table for a given year
...
# function to scrape data from the jersey wearers table for a given year
...
# function to scrape data from the stage winners table for a given year
...
# function to scrape data from the rankings tables for a given year
...
if __name__ == '__main__':
	...
	for year in list(reversed(list(dict_to_loop_over.keys()))): # starting from 1948, going backwards
